...
public class Graphic {
	...
	public class Speed {
		...
		/**
		 * @param speed
		 *            Speed in x direction. Negative amount means, the speed is
		 *            backward.
		 */
		...
		/**
		 * @param speed
		 *            Speed in y direction. Negative amount means, the speed is
		 *            backward.
		 */
	...
	/**
	 * Bitmap resize which should be drawn.
	 */
	 ...
	 *            Bitmap which should be drawn.
	 */
	public Graphic(ArrayList<Bitmap> bitmaps) {
		_bitmaps = bitmaps;
		_coordinates = new Coordinates();
		_speed = new Speed();
	}
